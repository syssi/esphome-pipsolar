...
void Pipsolar::handle_qflag_(const char *message) {
  ...
  if (this->silence_buzzer_open_buzzer_switch_ && values.silence_buzzer_open_buzzer.has_value())
    this->silence_buzzer_open_buzzer_switch_->publish_state(values.silence_buzzer_open_buzzer.value());
  if (this->overload_bypass_function_switch_ && values.overload_bypass_function.has_value())
    this->overload_bypass_function_switch_->publish_state(values.overload_bypass_function.value());
  ...
  if (this->overload_restart_function_switch_ && values.overload_restart_function.has_value())
    this->overload_restart_function_switch_->publish_state(values.overload_restart_function.value());
  if (this->over_temperature_restart_function_switch_ && values.over_temperature_restart_function.has_value())
    this->over_temperature_restart_function_switch_->publish_state(values.over_temperature_restart_function.value());
  if (this->backlight_on_switch_ && values.backlight_on.has_value())
    this->backlight_on_switch_->publish_state(values.backlight_on.value());
  if (this->alarm_on_when_primary_source_interrupt_switch_ && values.alarm_on_when_primary_source_interrupt.has_value())
