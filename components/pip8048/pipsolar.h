...
class Pipsolar : public uart::UARTDevice, public PollingComponent {
  ...
  PIPSOLAR_SWITCH(silence_buzzer_open_buzzer_switch, QFLAG)
  PIPSOLAR_SWITCH(overload_bypass_function_switch, QFLAG)
  PIPSOLAR_SWITCH(lcd_escape_to_default_switch, QFLAG)
  PIPSOLAR_SWITCH(overload_restart_function_switch, QFLAG)
  PIPSOLAR_SWITCH(over_temperature_restart_function_switch, QFLAG)
  PIPSOLAR_SWITCH(backlight_on_switch, QFLAG)
  PIPSOLAR_SWITCH(alarm_on_when_primary_source_interrupt_switch, QFLAG)
