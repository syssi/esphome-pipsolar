...
TYPES = {
    CONF_OUTPUT_SOURCE_PRIORITY_UTILITY: ("POP00", None), # UtilitySolarBat USB
    CONF_OUTPUT_SOURCE_PRIORITY_SOLAR: ("POP01", None),  # SolarUtilityBat SUB
    CONF_OUTPUT_SOURCE_PRIORITY_BATTERY: ("POP02", None), # SolarBatUtility SBU
