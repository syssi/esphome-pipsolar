    ...
    switch (this->used_polling_commands_[this->last_polling_command_].identifier) {
      case POLLING_QPIRI:
        ...
        if (this-value_current_max_ac_charging_current_select_) {
          ...
          this->value_current_max_ac_charging_current_select_->map_and_publish(value);
        }
        ...
        if (this-value_current_max_charging_current_select_) {
          std::string value = esphome::to_string(value_current_max_charging_current_);
          this->value_current_max_charging_current_select_->map_and_publish(value);
        }
